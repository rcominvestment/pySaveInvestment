...
def setFirebase(df,l_date,l_data):
    ...
    sheet_name = "Data_Oportunity_Hours"
    ...
    data_5min = yf.download(l_TICKER, start=l_data, end=None, interval="1h", group_by='tickers')
...
while True:
    ...
    l_data = str(year-1) + "-" + str(l_month) + "-" + str(l_day)

    """name_table = str(year) + "_" + str(l_month) + "_" + str(l_day) + "_" + str("16") + "_" + str("00")
    connectFirebase()
    setData(name_table)
    break"""
